...
pacman -Syu --noconfirm base-devel cpptrace git go gtk3 libxt mime-types dbus-glib nss ttf-liberation systemd vulkan-headers ffmpeg qt6-declarative qt6-base jemalloc qt6-svg libpipewire qt6-shadertools wayland-protocols cli11 ninja cmake polkit
